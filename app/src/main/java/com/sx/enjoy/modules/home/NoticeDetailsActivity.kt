    ...
    private fun initWebView(){
        ...
        wb_news_details.webViewClient = object : com.tencent.smtt.sdk.WebViewClient() {
            override fun onPageFinished(view: com.tencent.smtt.sdk.WebView, p1: String?) {
                ...
                try {
                    val screenWidth: Int = ScreenUtils.getScreenWidth(this@NoticeDetailsActivity)
                    val width2: String = java.lang.String.valueOf(DensityUtils.px2dp(this@NoticeDetailsActivity, screenWidth.toFloat()) - 20)
